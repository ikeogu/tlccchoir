...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" >
  ...
  <head>
    ...
    <title>{{ config('app.name', 'Noe Dashboard') }}</title>
      ...
      <div class="wrapper ">
          ...
          <div class="sidebar-wrapper">
              ...
              <li class="nav-item active">
                  <a class="nav-link" href="{{route('allteam')}}">
                  
                  <p>All Teams</p>
                  </a>
              </li>
              <li class="nav-item ">
                  <a class="nav-link" href="{{route('short_list.index')}}">
                 
                  <p>ShortListed Team</p>
                  </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link" href="{{route('short_list.create')}}">
