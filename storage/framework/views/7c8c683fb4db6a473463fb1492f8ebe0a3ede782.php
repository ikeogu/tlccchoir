...
<div class="col-md-12" style="padding-top:60px;">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <h3 class="card-category"><span text="class-success"> <?php echo e(App\Mgbidi::count()); ?> Registered. </h3><h4></span> Last Update <span text="class-success"> <?php echo e(App\Mgbidi::orderBy('updated_at', 'desc')->first()->updated_at->diffForHumans()); ?> </span> By <span text="class-success"> <?php echo e(App\Mgbidi::orderBy('firstname', 'desc')->first()->firstname); ?></span> 
                </h4>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <?php $__currentLoopData = $users->sortBy('firstname'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <tr>
                                ...
                                <td><a href="<?php echo e(action('MgbidiController@downloadPDF', $user->id)); ?>"> Download PDF</a></td>
