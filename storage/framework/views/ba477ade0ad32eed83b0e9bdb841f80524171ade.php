      ...
      <div class="section section-contacts">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <form class="contact-form" method="POST" action="<?php echo e(route('postmessage')); ?>">
              ...
              <div class="form-group">
                ...
                <textarea type="email" class="form-control" rows="4" id="exampleMessage" name="message"></textarea>
              </div>
              <div class="row">
