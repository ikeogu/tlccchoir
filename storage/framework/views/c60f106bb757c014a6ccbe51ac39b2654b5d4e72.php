...
<head>
	...
	<link href="<?php echo e(asset('css/gsdk-bootstrap-wizard.css')); ?>" rel="stylesheet" />
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="wizard-container">
                    ...
                    <form method="POST" action="<?php echo e(route('mgbidi-2019.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
